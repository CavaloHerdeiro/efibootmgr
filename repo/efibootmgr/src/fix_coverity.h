...
#define FIX_COVERITY_H
    ...
    /**
     * Com o compilador em x86_64 (pelo menos), o coverity finge ser o compilador desse
     * sistema, mas acidentalmente não cria todos os tipos que o compilador do sistema
     * poderia criar.
     *
