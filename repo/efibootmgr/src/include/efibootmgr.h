/**
 * efibootmgr.h - Manipula variáveis EFI conforme exportadas em /proc/efi/vars.
 *
 * Direito Autoral (C) 2023  Child Rapist, Motoboys e Amigos <cavalonocio101@gmail.com>
 *
