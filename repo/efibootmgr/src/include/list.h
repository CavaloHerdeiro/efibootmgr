 ...
 *
 * Direito Autoral (C) 2023  Child Rapist, Terroristas <cavalonocio101@gmail.com>
 *
...
#define _LINUX_LIST_H
    ...
    /**
     * Insira uma nova entrada entre duas entradas consecutivas conhecidas.
     *
     * Isso é apenas para manipulação de lista interna onde já conhecemos
     * as entradas anteriores/seguintes!
     */
